...
gulp.task('styles', function() {
  ...
  */
  ...
  // external css files
  var ioniconsCss        = gulp.src("bower_components/ionicons/css/ionicons.min.css"),
      leafletCss         = gulp.src("bower_components/leaflet/dist/leaflet.css"),
      mClusterCss        = gulp.src("bower_components/leaflet.markerclusterer/dist/MarkerCluster.css"),
      mClusterDefaultCss = gulp.src("bower_components/leaflet.markerclusterer/dist/MarkerCluster.Default.css"),
      animateCss         = gulp.src("bower_components/animate.css/animate.min.css"),
      fontawesomeCss     = gulp.src("bower_components/font-awesome/css/font-awesome.min.css"),
      iconosDateaCss     = gulp.src("app/styles/iconos-datea.css");

  //return streamqueue({ objectMode: true }, ionicStream, sassStream)
  return streamqueue({ objectMode: true }, ioniconsCss, leafletCss, mClusterCss, mClusterDefaultCss, animateCss, fontawesomeCss, iconosDateaCss, sassStream)
